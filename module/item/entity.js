...
export default class Item5e extends Item {
  ...
  prepareDerivedData() {
    ...
    if ( itemData.type === "class" ) {
      ...
      this.data.data.subclassName = this.data.data.subclass ? CONFIG.DND5E.classFeatures[itemData.name.slugify()]?.subclasses[this.data.data.subclass.slugify()]?.label : this.data.data.subclassOther;
    }
