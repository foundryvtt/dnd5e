...
export default class Actor5e extends Actor {
   ...
   * @param {boolean} [keepSelf] Keep self
   * @param {boolean} [keepAEOnlyOriginNotEquipment] Keep only active effects which origin is not equipment
  ...
  async transformInto(target, { keepPhysical=false, keepMental=false, keepSaves=false, keepSkills=false,
    ...
    // TODO solved with a backup of the info of the token
