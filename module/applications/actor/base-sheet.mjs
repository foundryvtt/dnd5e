...
export default class ActorSheet5e extends ActorSheetMixin(ActorSheet) {
  ...
  _filterItems(items, filters) {
    return items.filter(item => {
      ...
      if ( filters.has("ritual") && (item.system.properties.ritual !== true) ) return false;
      if ( filters.has("concentration") && (item.system.properties.concentration !== true) ) return false;
