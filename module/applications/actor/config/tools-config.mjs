...
export default class ToolsConfig extends TraitsConfig {
  ...
  static async #configureTool(event, target) {
    ...
    // TODO: Call proper config once https://github.com/foundryvtt/dnd5e/pull/4328 is merged
    new ProficiencyConfig(this.document, { property: this.options.trait, key }).render(true);
  }
