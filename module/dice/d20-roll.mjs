...
/**
 * Determine if the provided config object is in the old format.
 * @param {object} config  Config object to check.
 * @returns {boolean}
 * @internal
 */
export function _isDeprecatedConfig(config) {
  return ("parts" in config) || ("data" in config) || ("targetValue" in config) || ("fastForward" in config);
}
