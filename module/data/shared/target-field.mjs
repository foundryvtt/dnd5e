import { formatNumber, getPluralRules, prepareFormulaValue } from "../../utils.mjs";
  ...
  static prepareData(rollData, labels) {
    ...
    if ( templateConfig ) {
      ...
      if ( this.target.template.units in CONFIG.DND5E.movementUnits ) {
        // TODO: Switch to properly localized measurements with https://github.com/foundryvtt/dnd5e/issues/3958
