...
export default class ChatMessage5e extends ChatMessage {
  ...
  static addChatMessageContextOptions(html, options) {
    const canApply = li => {
      ...
      return game.messages.get(li.dataset.messageId)?.canApplyDamage;
    };
    const canTarget = li => {
      if ( !(li instanceof HTMLElement) ) li = li[0];
      return game.messages.get(li.dataset.messageId)?.canSelectTargets;
    };
    options.push(
      {
        ...
        callback: li => {
          if ( !(li instanceof HTMLElement) ) li = li[0];
          game.messages.get(li.dataset.messageId)?.applyChatCardDamage(li, 1);
        },
        group: "damage"
      },
      {
      ...
      },
      {
        ...
        callback: li => {
          if ( !(li instanceof HTMLElement) ) li = li[0];
          game.messages.get(li.dataset.messageId)?.applyChatCardTemp(li);
        },
        group: "damage"
      },
      {
        ...
        callback: li => {
          if ( !(li instanceof HTMLElement) ) li = li[0];
          game.messages.get(li.dataset.messageId)?.applyChatCardDamage(li, 2);
        },
        group: "damage"
      },
      {
        ...
        callback: li => {
          if ( !(li instanceof HTMLElement) ) li = li[0];
          game.messages.get(li.dataset.messageId)?.applyChatCardDamage(li, 0.5);
        },
        group: "damage"
      },
      {
        ...
        callback: li => {
          if ( !(li instanceof HTMLElement) ) li = li[0];
          game.messages.get(li.dataset.messageId)?.selectTargets(li, "hit");
        },
        group: "attack"
      },
      {
        ...
        callback: li => {
          if ( !(li instanceof HTMLElement) ) li = li[0];
          game.messages.get(li.dataset.messageId)?.selectTargets(li, "miss");
        },
        group: "attack"
      }
    );
