...
After creating the Check activity the configuration sheet will open on the "Identity" tab. In addition to the standard activity options (see the [Activities Overview](Activities.md) for more details), Check also includes an additional behavior option *Visible to All*. This determines whether the check button in the chat card is visible to all players, or only to the player who used the activity and the GM.

![Check Sheet - Identity Tab](https://raw.githubusercontent.com/foundryvtt/dnd5e/publish-wiki/wiki/images/activities/check-identity.jpg)

### Check Details

The "Effect" tab contains the rest of the unique properties for the Check activity.
...
- *Check Bonus*: The formula for an additional bonus that is added to all checks made through this activity
