...
Both of these modifiers also accept a number to increase the number of dice rolled for an advantage. For example, using `1d20adv2` would be equivalent of rolling `3d20kh`. This is used automatically in the system when rolling with Elven Accuracy feat.
